import { caption1, caption1Strong, caption2Strong } from '../type.js'
...
export function FilterChip({ label, selected, onSelect }) {
...
export function StatusChip({ children, bg, border, fg, title }) {
  return (
    <span
      title={title}
      style={{
