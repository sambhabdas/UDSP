import { body1, caption1, caption1Strong, subtitle2 } from '../type.js'
...
export function Menu({ children, width, minWidth, top = 36, left, right = 0, elevation = 'menu' }) {
  return (
    <div
      style={{
        position: 'absolute',
...
export function MenuItem({ children, onClick, selected = false, trailing }) {
...
export function DialogRow({ label, value }) {
  return (
...
export function Field({ children, height = 'var(--control-height)', small = false, style }) {
  return (
    <span
      data-field=""
      style={{
