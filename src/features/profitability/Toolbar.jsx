...
import { ALL, COMPARE_MODES, INPUT_ROWS, RANGES } from './data.js'
import { badge, fmtRangeNum } from './calc.js'
...
function Control({ children, width, maxWidth, onClick }) {
...
function PeriodRow({ pid, dates, dot, tag, selected, onClick }) {
  const [hover, hoverProps] = useHover()
  return (
    <div
      onClick={onClick}
