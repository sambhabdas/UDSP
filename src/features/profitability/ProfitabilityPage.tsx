...
import type { TimedPeriod } from './data'
import { useCallback, useRef } from 'react'
import { Toast } from '../../ds/components/Overlay'
import { Toolbar } from './Toolbar'
import { CurrentStrip, MoneyKpis, SectionLabel, WhatMovesIt } from './Summary'
import {
  CostBreakdown,
  PerRouteEconomics,
  RegularVsOvertime,
...
import { ALL, CURRENT, PERIODS } from './data'
...
export function ProfitabilityPage() {
  ...
  const last3 = ALL.filter((p): p is TimedPeriod => p.hours !== null).slice(-3)
