...
import { body1, caption1, caption1Strong, caption2Strong, subtitle1, subtitle2 } from '../../ds/type'
import {
  ACCESS_UNTIL,
  CANCEL_BODY,
  CARD,
...
function PeriodPicker({ s }: { s: BillingState }) {
...
function CancelDialog({ s }: { s: BillingState }) {
  return (
    <div
