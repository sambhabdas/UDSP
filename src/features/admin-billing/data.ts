...
// driver at 6am.
/** A metered allowance and what each unit past it costs. */
...
export const METER_SPECS: MeterSpec[] = [
  {
    key: 'sms',
    label: 'SMS',
    cap: 5000,
...
/** A sortable column, or the trailing actions column when `k` is null. */
export interface Head {
  k: 'date' | 'num' | 'amt' | 'status' | null
  label: string
  w?: number
  flex?: number
  right?: boolean
...
export const INVOICE_HEADS: Head[] = [
