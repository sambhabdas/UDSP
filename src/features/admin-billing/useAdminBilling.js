...
export function useAdminBilling() {
  ...
  const [invSort, setInvSort] = useState({ col: 'date', dir: 'desc' })
  const [invMenuFor, setInvMenuFor] = useState(null)
    ...
    () =>
      METER_SPECS.map((spec) => {
        ...
        return {
          ...
          capLabel: spec.cap.toLocaleString(),
  ...
  const sortInvoices = useCallback((k) => {
