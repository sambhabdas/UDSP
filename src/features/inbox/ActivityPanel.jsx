import { FilterChip, StatusChip } from '../../ds/components/Chip.jsx'
import { useHover } from '../../ds/useHover.js'
import { body1Strong, caption1, caption1Strong } from '../../ds/type.js'
import { CHANNELS, initials, tint } from './data.js'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {onRoute ? `On route · ${person.route.split(' ·')[0]}` : 'Off duty'}
        </StatusChip>
        <div style={{ flex: 1 }} />
