...
import type { ComposerTab } from './data'
import { useRef, useState } from 'react'
import { Icon } from '../../ds/icons/Icon'
import { useHover } from '../../ds/useHover'
import { body1, body1Strong, caption2 } from '../../ds/type'
import { COMPOSER_TABS, EMOJIS, STATION_LINE } from './data'
...
export function Composer({
  ...
  onSend,
  onCall,
}: ComposerProps & { firstName: string }) {
...
function EmojiCell({ ch, onPick }: { ch: string; onPick: () => void }) {
  const [hover, hoverProps] = useHover()
  return (
    <span
      onClick={onPick}
