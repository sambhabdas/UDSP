...
const stamp = { ...caption2, color: 'var(--text-helper)' }
...
function InboundText({ text, time }) {
  return (
    <div
      style={{
...
function OutboundText({ text, time }) {
  return (
    <div
      style={{
        alignSelf: 'flex-end',
...
function EmailEntry({ text, sub, dir }) {
