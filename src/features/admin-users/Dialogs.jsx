...
import { body1, caption1, caption1Strong, caption2 } from '../../ds/type.js'
import { ASSIGNABLE_ROLES, IMPORT_FIELDS, IMPORT_FILE, REMOVE_BODY, SEAT_CAP } from './data.js'
import {
  Btn,
  CheckBox,
  Labelled,
...
function RolePick({ label, on, onPick }) {
...
export function RemoveDialog({ s }) {
...
export function TransferDialog({ s }) {
  return (
...
function TargetRow({ t, on, onPick }) {
  return (
    <div
      onClick={onPick}
      style={{
...
export function DaInviteDialog({ s }) {
...
function CandidateRow({ d, on, onToggle }) {
