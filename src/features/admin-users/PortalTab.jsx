...
import { ASSIGNABLE_ROLES, SEAT_CAP, STATUS_TONE, USER_HEADS, WHY } from './data.js'
import {
  CheckBox,
  FilterButton,
  HeadCell,
...
import { TONES } from './ui.js'

export function PortalTab({ s }) {
  const kpis = [
    ...
    <>
      ...
      <TableCard>
        ...
        <TableScroll minWidth={960}>
          <HeadRow>
            {USER_HEADS.map((h) => (
              <HeadCell key={h.label} h={h} sort={s.sort} onSort={() => s.sortBy(h.k)} />
            ))}
          </HeadRow>
