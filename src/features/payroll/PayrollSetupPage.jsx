...
import { IconButton, StatusPill } from '../../ds/components/Button.jsx'
import { Field, Menu, MenuItem, Toast } from '../../ds/components/Overlay.jsx'
import { useHover } from '../../ds/useHover.js'
import { body1, caption1, caption2Strong } from '../../ds/type.js'
import { fmtD, fmtRange, periodWeeks } from './calendar.js'
import { STATUS_NAME, STATUS_TONE, YEARS } from './data.js'
import { usePayrollSetup } from './usePayrollSetup.js'
import { CalendarTab } from './CalendarTab.jsx'
import { UploadTab } from './UploadTab.jsx'
import { PayrollDialogs } from './PayrollDialogs.jsx'
...
function PeriodOption({ row, state, selected, dataYear, onPick }) {
  const [hover, hoverProps] = useHover()
  return (
    <div
      onClick={onPick}
