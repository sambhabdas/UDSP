...
import { Axis, ChartCard, Plot, ReferenceRule } from '../../../ds/charts/ChartKit'
import { AXIS, BLOCK_HOURS, DAYS, PEOPLE } from '../data'

const H = 196

// The day's six busiest drivers, scaled from the reference day's hours so the
// shape follows whichever day is open.
export function HoursPerRoute({ dayIdx }: { dayIdx: number }) {
