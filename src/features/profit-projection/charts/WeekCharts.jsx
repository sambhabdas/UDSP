...
import { AXIS, BREAK_EVEN, DAYS } from '../data.js'
import {
  colLeft,
  costOf,
  cprOf,
...
const projectedBar = (value, ceiling, solid, projected) => ({
...
export function DailyPL({ locked, tip, setTip, onPickDay }) {
...
export function CostPerRoute({ tip, setTip, onPickDay }) {
...
export function PerRouteEconomics({ locked, tip, setTip, onPickDay }) {
...
function PairedChart({ title, legend, leftTicks, rightTicks, cols, tipNode, labels }) {
  return (
...
export function RegularVsOvertime({ locked, tip, setTip, onPickDay }) {
...
export function WorkforceUtilization({ locked, tip, setTip, onPickDay }) {
