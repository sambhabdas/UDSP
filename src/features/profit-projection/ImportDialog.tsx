...
import { body1Strong, caption1, caption1Strong, caption2Strong, subtitle2, title3 } from '../../ds/type'
import {
  IMPORT_FILE,
  MAP_ROWS,
  SPLIT_BASE,
...
const boxed: CSSProperties = { border: '1px solid var(--border-default)', borderRadius: 'var(--radius-medium)', overflow: 'hidden' }
...
export function ImportDialog({ s }: { s: ProjectionState }) {
  ...
  const notice = (msg: string) => (e: MouseEvent<HTMLDivElement>) => {
    e.stopPropagation()
    s.toast(msg)
  }
