...
import { caption1, caption1Strong, subtitle1, subtitle2, title3 } from '../../ds/type.js'
import { EYEBROW } from './tokens.js'
import { DAYS, SEG_COLORS, SEG_TEXT, WEEK_BREAKDOWN } from './data.js'
import {
  DASH,
  breakdownOf,
  costOf,
...
function GridCell({ label, children }) {
  return (
    <div
      style={{
        boxSizing: 'border-box',
...
export function ProjectionInputs({ s }) {
...
function chipVs(cur, prev, invert, vsLabel, grain) {
...
export function CostBreakdown({ s }) {
  const di = s.dayIdx
