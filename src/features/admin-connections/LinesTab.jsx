...
import { ASSIGN_KINDS, GREETINGS, INFO, LINE_HEADS, PRESENCE_DOT, TTS, USER_POOL, WHY } from './data.js'
import {
  Card,
  Chip,
  ChipRow,
        ...
        <Card pad="0" gap="0" overflow="visible">
          ...
          <div style={{ overflowX: 'auto', paddingBottom: lineMenuOpen ? MENU_ROOM : 0 }}>
            <div style={{ minWidth: MIN_WIDTH }}>
              <HeadRow>
                {LINE_HEADS.map((h) => (
                  <HeadCell key={h.label} h={h} sort={s.lnSort} onSort={() => s.sortLines(h.k)} />
                ))}
              </HeadRow>
