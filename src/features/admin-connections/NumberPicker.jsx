import { caption1, caption2 } from '../../ds/type.js'
import { Dropdown, EmptyRow, OptionRow } from './parts.jsx'
...
// "815" then pick.
export function NumberPicker({ pool, state, patch, openKey, openDrop, setOpenDrop, reservedNumbers, filterNumbers, areaOptions }) {
