...
import { IMAP, INFO, MAIL_PROVIDERS, MAIL_SCOPE_NOTE } from './data'
import { Card, Helper, Section, SmallButton } from './parts'

export function MailboxTab({ s }: { s: ConnectionsState }) {
  return (
...
function ProviderCard({ name, sub, onPick }: { name: string; sub: string; onPick: () => void }) {
