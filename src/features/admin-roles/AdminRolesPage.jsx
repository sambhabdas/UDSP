...
import { body1, body1Strong, caption2Strong } from '../../ds/type.js'
import { Ladder } from './Ladder.jsx'
import { Matrix } from './Matrix.jsx'
import { Protected, Splits } from './Panels.jsx'
import { BANNER, POSTS } from './data.js'
...
export function AdminRolesPage() {
  ...
  const selIdx = POSTS.indexOf(selPost)
