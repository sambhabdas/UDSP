...
/** One of the four cell values: Full, Read, a named partial, or nothing. */
export type Cell = typeof FULL | typeof READ | typeof DASH | typeof PUNCH
...
type Entry = { isBand: true; band: string } | ({ isBand: false } & CapRow)
...
export const BANDS = FLAT.reduce<Band[]>((out, m) => {
