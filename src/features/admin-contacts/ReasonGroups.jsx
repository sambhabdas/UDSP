...
import { caption1, caption1Strong, caption2 } from '../../ds/type.js'
...
function reachOf(r, total, visible) {
...
function GroupHeader({ cat, meta, open, onToggle }) {
  return (
    <div
      onClick={onToggle}
      style={{
...
function ReasonRow({ r, on, total, visible, showUrgent, rename, setRename, onCommitRename, onToggle }) {
