...
import { body1, body1Strong, caption1, caption1Strong, caption2, subtitle2 } from '../../ds/type.js'
import { ReasonGroups } from './ReasonGroups.jsx'
import { CategorySelect, InfoDot, SearchField } from './ReasonsPanel.jsx'
import { CHOSEN_LIMIT, STATION_LINES, TITLE_HELP } from './data.js'
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--size-120)', padding: 'var(--size-200)' }}>
          ...
          <div style={{ display: 'flex', gap: 'var(--size-80)', flexWrap: 'wrap' }}>
            ...
            <CategorySelect
              ...
              isDuplicate={
                s.ncNew.trim() && s.allCategories.some((c) => c.toLowerCase() === s.ncNew.trim().toLowerCase())
              }
            />
          </div>
